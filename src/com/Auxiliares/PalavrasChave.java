...
public class PalavrasChave {
  ...
  public static boolean isPalavraChave(StringBuffer palavra) {
    ...
    if (
      palavra1.equals(CHAR) ||
      palavra1.equals(ELSE) ||
      palavra1.equals(FALSE) ||
      palavra1.equals(INT) ||
      palavra1.equals(IF) ||
      palavra1.equals(MAIN) ||
      palavra1.equals(OUT) ||
      palavra1.equals(PRINTF) ||
      palavra1.equals(RETURN) ||
      palavra1.equals(STATIC) ||
      palavra1.equals(VOID) ||
      palavra1.equals(WHILE) ||
      palavra1.equals(TRUE) ||
      palavra1.equals(NULL) ||
      palavra1.equals(NEW) ||
      palavra1.equals(THIS)
    ) {
      return true;
    }
